%GMRESIR_EXAMPLE_VPA    Example script for comparing LU-IR and GMRES-IR (with 2 precisions)
...
for i = 1:numel(condnums_double)
    ...
    fprintf('Running GMRES-IR\n'); 
    gmresir3_vpa(A,b,2,2,4,maxit,1e-4);
    drawnow
